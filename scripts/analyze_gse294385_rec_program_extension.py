...
def main() -> None:
    ...
    provenance_rows = []
    for row in manifest.itertuples(index=False):
        archive_path = ARCHIVES / str(row.archive_name)
        provenance_rows.append({
            ...
            "actual_size_bytes": archive_path.stat().st_size,
    ...
    lines = [
        ...
        "## Reproducibility",
        "",
        f"Specification: `{SPEC.relative_to(ROOT)}`. All 24 liver archives were size-checked and SHA-256 hashed.",
    ]
